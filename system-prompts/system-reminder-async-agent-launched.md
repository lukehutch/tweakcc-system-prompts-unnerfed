...
variables:
  ...
  - READ_TOOL_NAME
-->
Do not duplicate this agent's work — avoid working with the same files or topics it is using. Work on non-overlapping tasks, or tell the user what you launched and why you launched it, then end your response.
